...
<div class="navbar-header">
  ...
  <div class="logo"> <a href="index.html"><img class="logo logo-display" src="assets/images/LOGfO.png" alt=""> <img class="logo logo-scrolled" src="assets/images/LOGO.png" alt=""> </a> </div>
</div>
...
<div class="collapse navbar-collapse" id="navbar-menu">
  <ul class="nav navbar-nav navbar-center" data-in="fadeIn" data-out="fadeOut">
    ...
    <li><a class="page-scroll" href="#itsolution">IT SOLLUTIONS</a></li>
    <li><a class="page-scroll" href="#business">Business SOLUTIONS</a></li>
...
<div class="side dark-bg">
      <a href="index.html" class="logo-side"><img src="assets/images/logo-white.jpeg" alt="side-logo"/></a>
